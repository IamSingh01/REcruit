...
// ── Shared form initial state (single declaration, no duplicate) ──
const FORM_INITIAL = {
          ...
          <div className="services-grid reveal" ref={r1} style={{ marginTop: "44px" }}>
            {[
              ...
              >
                ...
                <p className="service-card__body" style={{ fontSize: "1rem" }}>{s.body}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <div className="inline-form__row">
        ...
        <div className="form-field">
          ...
          <input type="tel" placeholder="+971 XX XXX XXXX"
            value={form.phone} onChange={set("phone")} disabled={status === "sending"} />
        </div>
      </div>
      <div className="form-field">
        <label>Message *</label>
